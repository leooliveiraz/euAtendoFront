    ...
    $.ajax({
        ...
        success: function (data, textStatus, jQxhr) {
            $(data).each(function () {
                ...
                carregarimagem(cardempresa,empresa.path_img);
                cardempresa.find("#fotoempresa").append(empresa.nome);
...
function carregarimagem(card ,numeroimg){
    $.ajax({
        type: 'GET',
        url: urlimg+numeroimg,
        async: true,
        success: function(data, textStatus, jQxhr) {    
            card.find("#fotoempresa").attr("src",data);        
        }
    }); 
}